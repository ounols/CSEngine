...
public:
	...
	Matrix2(const T* m) {
		MAT2_XX = m[0]; MAT2_XY = m[1];
		MAT2_YX = m[2]; MAT2_YY = m[3];
	}
...
public:
	...
	Matrix3() {
		MAT3_XX = 1; MAT3_XY = 0; MAT3_XZ = 0;
		MAT3_YX = 0; MAT3_YY = 1; MAT3_YZ = 0;
		MAT3_ZX = 0; MAT3_ZY = 0; MAT3_ZZ = 1;
	}

	Matrix3(const T* m) {
		MAT3_XX = m[0]; MAT3_XY = m[1]; MAT3_XZ = m[2];
		MAT3_YX = m[3]; MAT3_YY = m[4]; MAT3_YZ = m[5];
		MAT3_ZX = m[6]; MAT3_ZY = m[7]; MAT3_ZZ = m[8];
	}
	...
	Matrix3 Transposed() const {
		Matrix3 m;
		m.MAT3_XX = MAT3_XX; m.MAT3_XY = MAT3_YX; m.MAT3_XZ = MAT3_ZX;
		m.MAT3_YX = MAT3_XY; m.MAT3_YY = MAT3_YY; m.MAT3_YZ = MAT3_ZY;
		m.MAT3_ZX = MAT3_XZ; m.MAT3_ZY = MAT3_YZ; m.MAT3_ZZ = MAT3_ZZ;
		return m;
	}
...
public:
	...
	Matrix4() {
		MAT4_XX = 1; MAT4_XY = 0; MAT4_XZ = 0; MAT4_XW = 0;
		MAT4_YX = 0; MAT4_YY = 1; MAT4_YZ = 0; MAT4_YW = 0;
		MAT4_ZX = 0; MAT4_ZY = 0; MAT4_ZZ = 1; MAT4_ZW = 0;
		MAT4_WX = 0; MAT4_WY = 0; MAT4_WZ = 0; MAT4_WW = 1;
	}

	Matrix4(const Matrix3<T>& m) {
		MAT4_XX = m.MAT4_XX; MAT4_XY = m.MAT4_XY; MAT4_XZ = m.MAT4_XZ; MAT4_XW = 0;
		MAT4_YX = m.MAT4_YX; MAT4_YY = m.MAT4_YY; MAT4_YZ = m.MAT4_YZ; MAT4_YW = 0;
		MAT4_ZX = m.MAT4_ZX; MAT4_ZY = m.MAT4_ZY; MAT4_ZZ = m.MAT4_ZZ; MAT4_ZW = 0;
		MAT4_WX = 0; MAT4_WY = 0; MAT4_WZ = 0; MAT4_WW = 1;
	}

	Matrix4(const T* m) {
		MAT4_XX = m[0];  MAT4_XY = m[1];  MAT4_XZ = m[2];  MAT4_XW = m[3];
		MAT4_YX = m[4];  MAT4_YY = m[5];  MAT4_YZ = m[6];  MAT4_YW = m[7];
		MAT4_ZX = m[8];  MAT4_ZY = m[9];  MAT4_ZZ = m[10]; MAT4_ZW = m[11];
		MAT4_WX = m[12]; MAT4_WY = m[13]; MAT4_WZ = m[14]; MAT4_WW = m[15];
	}
	...
	Matrix4 Transposed() const {
		Matrix4 m;
		m.MAT4_XX = MAT4_XX; m.MAT4_XY = MAT4_YX; m.MAT4_XZ = MAT4_ZX; m.MAT4_XW = MAT4_WX;
		m.MAT4_YX = MAT4_XY; m.MAT4_YY = MAT4_YY; m.MAT4_YZ = MAT4_ZY; m.MAT4_YW = MAT4_WY;
		m.MAT4_ZX = MAT4_XZ; m.MAT4_ZY = MAT4_YZ; m.MAT4_ZZ = MAT4_ZZ; m.MAT4_ZW = MAT4_WZ;
		m.MAT4_WX = MAT4_XW; m.MAT4_WY = MAT4_YW; m.MAT4_WZ = MAT4_ZW; m.MAT4_WW = MAT4_WW;
		return m;
	}

	Matrix3<T> ToMat3() const {
		Matrix3<T> m;
		m.MAT3_XX = MAT4_XX; m.MAT3_YX = MAT4_YX; m.MAT3_ZX = MAT4_ZX;
		m.MAT3_XY = MAT4_XY; m.MAT3_YY = MAT4_YY; m.MAT3_ZY = MAT4_ZY;
		m.MAT3_XZ = MAT4_XZ; m.MAT3_YZ = MAT4_YZ; m.MAT3_ZZ = MAT4_ZZ;
		return m;
	}
	...
	static Matrix4<T> Translate(T x, T y, T z) {
		Matrix4 m;
		m.MAT4_XX = 1; m.MAT4_XY = 0; m.MAT4_XZ = 0; m.MAT4_XW = 0;
		m.MAT4_YX = 0; m.MAT4_YY = 1; m.MAT4_YZ = 0; m.MAT4_YW = 0;
		m.MAT4_ZX = 0; m.MAT4_ZY = 0; m.MAT4_ZZ = 1; m.MAT4_ZW = 0;
		m.MAT4_WX = x; m.MAT4_WY = y; m.MAT4_WZ = z; m.MAT4_WW = 1;
		return m;
	}

	static Matrix4<T> Scale(T s) {
		Matrix4 m;
		m.MAT4_XX = s; m.MAT4_XY = 0; m.MAT4_XZ = 0; m.MAT4_XW = 0;
		m.MAT4_YX = 0; m.MAT4_YY = s; m.MAT4_YZ = 0; m.MAT4_YW = 0;
		m.MAT4_ZX = 0; m.MAT4_ZY = 0; m.MAT4_ZZ = s; m.MAT4_ZW = 0;
	...
	static Matrix4<T> Scale(T x, T y, T z) {
		...
		Matrix4 m;
		m.MAT4_XX = x; m.MAT4_XY = 0; m.MAT4_XZ = 0; m.MAT4_XW = 0;
		m.MAT4_YX = 0; m.MAT4_YY = y; m.MAT4_YZ = 0; m.MAT4_YW = 0;
		m.MAT4_ZX = 0; m.MAT4_ZY = 0; m.MAT4_ZZ = z; m.MAT4_ZW = 0;
		m.MAT4_WX = 0; m.MAT4_WY = 0; m.MAT4_WZ = 0; m.MAT4_WW = 1;
		return m;
	}
	static Matrix4<T> RotateZ(T degrees)
	{
		...
		Matrix4 m;
		m.MAT4_XX = c; m.MAT4_XY = -s; m.MAT4_XZ = 0; m.MAT4_XW = 0;
		m.MAT4_YX = s; m.MAT4_YY = c; m.MAT4_YZ = 0; m.MAT4_YW = 0;
		m.MAT4_ZX = 0; m.MAT4_ZY = 0; m.MAT4_ZZ = 1; m.MAT4_ZW = 0;
		m.MAT4_WX = 0; m.MAT4_WY = 0; m.MAT4_WZ = 0; m.MAT4_WW = 1;
		return m;
	}
	...
	static Matrix4<T> RotateY(T degrees) {
		...
		Matrix4 m;
		m.MAT4_XX = c; m.MAT4_XY = 0; m.MAT4_XZ = s; m.MAT4_XW = 0;
		m.MAT4_YX = 0; m.MAT4_YY = 1; m.MAT4_YZ = 0; m.MAT4_YW = 0;
		m.MAT4_ZX = -s; m.MAT4_ZY = 0; m.MAT4_ZZ = c; m.MAT4_ZW = 0;
		m.MAT4_WX = 0; m.MAT4_WY = 0; m.MAT4_WZ = 0; m.MAT4_WW = 1;
		return m;
	}
	...
	static Matrix4<T> RotateX(T degrees) {
		...
		Matrix4 m;
		m.MAT4_XX = 1; m.MAT4_XY = 0; m.MAT4_XZ = 0; m.MAT4_XW = 0;
		m.MAT4_YX = 0; m.MAT4_YY = c; m.MAT4_YZ = -s; m.MAT4_YW = 0;
		m.MAT4_ZX = 0; m.MAT4_ZY = s; m.MAT4_ZZ = c; m.MAT4_ZW = 0;
		m.MAT4_WX = 0; m.MAT4_WY = 0; m.MAT4_WZ = 0; m.MAT4_WW = 1;
		return m;
	}
	...
	static Matrix4<T> Frustum(T tLeft, T tRight, T tBottom, T tTop, T tNear, T tFar) {
		...
		Matrix4 m;
		m.MAT4_XX = a; m.MAT4_XY = 0; m.MAT4_XZ = 0; m.MAT4_XW = 0;
		m.MAT4_YX = 0; m.MAT4_YY = b; m.MAT4_YZ = 0; m.MAT4_YW = 0;
		m.MAT4_ZX = c; m.MAT4_ZY = d; m.MAT4_ZZ = e; m.MAT4_ZW = -1;
		m.MAT4_WX = 0; m.MAT4_WY = 0; m.MAT4_WZ = f; m.MAT4_WW = 1;
		return m;
	}
